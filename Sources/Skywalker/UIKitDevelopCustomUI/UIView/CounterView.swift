...
public class CounterView: UIView {
    ...
    @IBInspectable var outlineColor: UIColor = UIColor.init(red: 34, green: 110, blue: 100, alpha: 1)// 刻度圆弧颜色
    @IBInspectable var counterColor: UIColor = UIColor.init(red: 87, green: 218, blue: 213, alpha: 1)// 背景圆弧的颜色
    ...
    public override func draw(_ rect: CGRect) {
        ...
        let path = UIBezierPath.init(arcCenter: center, radius: (radiusBase - Constants.arcWidth) / 2, startAngle: startAngle, endAngle: endAngle, clockwise: true)
        ...
        let outlinePath = UIBezierPath.init(arcCenter: center, radius: outerArcRadius, startAngle: startAngle, endAngle: outlineEndAngle, clockwise: true)
